...
public class databaseHard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.database_hard);

        list=new ArrayList<>();
        databaseReference = FirebaseDatabase.getInstance().getReference("DatabaseHard");
...
//        list.add(new Modelclass("The values appearing in given attributes of any tuple in the referencing relation must likewise occur in specified attributes of at least one tuple in the referenced relation, according to _____________________ integrity constraint.","Referential","Primary","Referencing","Specific","Referential"));
        ...
        countDownTimer = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                Dialog dialog = new Dialog(databaseHard.this);
                dialog.setContentView(R.layout.time_out_dialog);

                dialog.findViewById(R.id.btn_tryAgain).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(databaseHard.this,DatabaseBtn.class);
    ...
    private void GameWon() {
        ...
        Intent intent = new Intent(databaseHard.this,WonActivity.class);
